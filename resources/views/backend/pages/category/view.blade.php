...
<section class="bg-light py-6">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6">
        <h1 class="h2 mb-0">Category Page</h1>
      </div>
    </div>
    <!-- / .row -->
  </div>
      ...
      <div class="col-lg-6 col-12">
        <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img" src="{{url('uploads/products'). '/' .$category->image}}" data-zoom-image="{{url('frontend/assets/images/product/p11.jpg')}}" alt="product_img1" />
                    </div>
                </div>
      </div>
      <div class="col-lg-6 col-12 mt-5 mt-lg-0">
        <div class="product-details">
          <h1 class="h4 mb-0 font-w-6">{{$category->name}}</h1>
          <span class="product-price h5 text-pink">Status:{{$category->status}}</span>
          <ul class="list-unstyled my-5">
          </ul>
          <p class="mb-5 border-top border-bottom pb-5 pt-5 desc">{{$category->description}}</p>
