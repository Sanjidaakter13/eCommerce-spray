  ...
  <div class="container">
    <div class="row align-items-center justify-content-between">
      <div class="col-12 col-lg-6 mb-6 mb-lg-0">
            <img src="{{url('frontend/assets/images/about/01.jpg')}}" class="img-fluid rounded shadow" alt="...">
  ...
  <div class="container text-center">
    <div class="row justify-content-center">
      <div class="col-12 pl-10 pr-10">
        <div class="owl-carousel owl-center owl-2" data-center="true" data-dots="false" data-nav="true" data-items="1" data-md-items="1" data-sm-items="1">
          <div class="item">
            <div class="card p-lg-10 bg-primary-soft border-0">
              <div>
                <img alt="Image" src="{{url('frontend/assets/images/thumbnail/member2.png')}}" class="img-fluid rounded-circle d-inline">
              </div>
              <div class="card-body pl-10 pr-10">
               <p class="text-dark font-w-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla auguest tristique auctor. placerat a condimentum diam mollis. Ut pulvinar neque eget massa dapibus dolor.</p>
                <div>
          ...
          <div class="item">
            <div class="card p-lg-10 bg-primary-soft border-0">
              <div>
                <img alt="Image" src="{{url('frontend/assets/images/thumbnail/member1.png')}}" class="img-fluid rounded-circle d-inline">
              </div>
              <div class="card-body pl-10 pr-10">
                <p class="text-dark font-w-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla auguest tristique auctor. placerat a condimentum diam mollis. Ut pulvinar neque eget massa dapibus dolor.</p>
                <div>
          ...
          <div class="item">
            <div class="card p-lg-10 bg-primary-soft border-0">
              <div>
                <img alt="Image" src="{{url('frontend/assets/images/thumbnail/member3.png')}}" class="img-fluid rounded-circle d-inline">
              </div>
              <div class="card-body pl-10 pr-10">
                <p class="text-dark font-w-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla auguest tristique auctor. placerat a condimentum diam mollis. Ut pulvinar neque eget massa dapibus dolor.</p>
                <div>
...
<div class="row justify-content-center text-center">
 ...
 <img src="{{url('frontend/assets/images/thumbnail/member1.png')}}" alt="Image">
      ...
      <div class="col-12 col-lg-3 col-md-6">
      <img src="{{url('frontend/assets/images/thumbnail/member2.png')}}" alt="Image">
      ...
      <div class="col-12 col-lg-3 col-md-6">
      <img src="{{url('frontend/assets/images/thumbnail/member3.png')}}" alt="Image">
          ...
          <div class="col-12 col-lg-4"> 
            ...
            <div class="card border-0 bg-transparent">
              <div class="position-relative rounded overflow-hidden">
                <div class="position-absolute z-index-1 bg-white text-pink text-center py-1 px-3 my-4">12 Jul</div>
          ...
          <div class="col-12 col-lg-4 mt-5 mt-lg-0"> 
            ...
            <div class="card border-0 bg-transparent">
              <div class="position-relative rounded overflow-hidden bg-light-4">
                <div class="position-absolute z-index-1 bg-white text-pink text-center py-1 px-3 my-4">27 Feb</div>
